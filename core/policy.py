...
from core.custom_anomaly_detection import BetterAnomalyDetection
...
class Policy(Module):
    ...
    def __init__(self, encoder, hidden_size, num_programs, num_non_primary_programs, embedding_dim,
                 encoding_dim, indices_non_primary_programs, learning_rate=1e-3, use_args=True, use_gpu=False):
